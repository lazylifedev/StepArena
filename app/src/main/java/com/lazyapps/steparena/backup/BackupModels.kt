...
const val BACKUP_LEASE_VERSION = 1
const val BACKUP_LEASE_DURATION_MINUTES = 30L
...
enum class BackupWriteStage {
    ...
    ACHIEVEMENTS, INTEGRITY_SEGMENTS, SETTINGS, LEASE_ACTIVE, LEASE_TAKEOVER,
    LEASE_HEARTBEAT, FENCED_CHILD_WRITE, FENCED_ROOT_COMPLETE, ROOT_COMPLETE,
}
